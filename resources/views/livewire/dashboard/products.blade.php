...
<br /><br /><br />
                <div class="row w-100">
                    <div class="col-sm-12 col-md-4 mb-2">
                        <input type="text" id="searchInput" wire:model.debounce.500ms="search"
                               placeholder="بحث في كل الأعمدة" class="form-control">
                    </div>
                            ...
                            <tbody>
                                @foreach ($products as $index => $product)
                                    <tr>
                                        ...
                                        <td>
                                            <img src="{{ $product->image_path }}" style="width: 80px"
                                                 class="img-thumbnail" alt="صورة المنتج">
                                        </td>
