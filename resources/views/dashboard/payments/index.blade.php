                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" step="0.01" name="amount" class="form-control" required>
                          <small class="remaining-text" style="color: red">رصيد المتبقي الحالي: 0.00</small>
                    </div>
                    <div class="form-group">
...
<script>
    ...
    $('#paymentOrderId').val(orderId);
    $('#paymentModal').find('small.remaining-text').text('رصيد المتبقي الحالي: ' + parseFloat(remaining).toFixed(2));
});
